...
//               c:/GIT/NullShift/NullShift.gen/sources_1/bd/fdm/ip/fdm_mult_gen_1_0/fdm_mult_gen_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "fdm_mult_gen_1_0,mult_gen_v12_0_24,{}" *) (* core_generation_info = "fdm_mult_gen_1_0,mult_gen_v12_0_24,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=mult_gen,x_ipVersion=12.0,x_ipCoreRevision=24,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_VERBOSITY=0,C_MODEL_TYPE=0,C_OPTIMIZE_GOAL=1,C_XDEVICEFAMILY=zynq,C_HAS_CE=0,C_HAS_SCLR=0,C_LATENCY=1,C_A_WIDTH=32,C_A_TYPE=0,C_B_WIDTH=8,C_B_TYPE=0,C_OUT_HIGH=39,C_OUT_LOW=0,C_MULT_TYPE=0,C_CE_OVERRIDES_SCLR=0,C_CCM_IMP=0,C_B_VALUE=10000001,C_HAS_ZERO_DETECT=0,C_ROUND_OUTPUT=0,C_ROUND_PT=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "mult_gen_v12_0_24,Vivado 2025.2" *) 
module fdm_mult_gen_1_0(CLK, A, B, P)
/* synthesis syn_black_box black_box_pad_pin="A[31:0],B[7:0],P[39:0]" */
